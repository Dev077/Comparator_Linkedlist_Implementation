...
// create and link a new node
     ...
     */
    public Node<E> findNode(E e){ // This method returns the Node that contains the element e, or it returns null if the list is empty
        Node temp = header;
    ...
    public String toString(){  // overriding the toString method
        ...
        ArrayList n = new ArrayList<E>();
        Node temp = header;

        while(temp != null){
            n.add(temp.getElement());
            temp = temp.getNext();
        }
